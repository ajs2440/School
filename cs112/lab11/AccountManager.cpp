...
void AccountManager::changeUserName(const string& oldUserName, const string& newUserName) {
	...
	if (it != myAccounts.end() && myAccounts.find(newUserName) == myAccounts.end()) {
		...
		throw Exception("AccountManager::changeUserName(oldUserName, newUserName): ", "oldUserName is not present in map, or newUserName already exists in map");
	}
}
...
void AccountManager::deleteAccount(const string& userName) {
	if(myAccounts.find(userName) != myAccounts.end()) {
		...
		throw Exception("AccountManager::deleteAccount(userName): ", "userName is not present in map");
	}
}
...
void AccountManager::changePassword(const string& userName,
	...
	if(it != myAccounts.end()) {
		...
		throw Exception("AccountManager::changePassword(userName, newPassword): ", "userName is not present in map");
	}
}
