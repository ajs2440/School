...
void SongTester::testOperator() {
	cout << "- testOperator()... " << flush;

	Song song2("A Song", "An Artist", 2018);

	// same song case
	Song s7("A Song", "An Artist", 2018);
	assert (s7.operator==(song2));
	cout << " 0 " << flush;

	// different title case
	Song s8("Second Song", "An Artist", 2018);
	assert (!(s8.operator==(song2)));
	cout << " 1 " << flush;

	// different artist case
	Song s9("A Song", "Second Artist", 2018);
	assert (!(s9.operator==(song2)));
	cout << " 2 " << flush;

	// different year case
	Song s10("A Song", "An Artist", 2017);
	assert (!(s10.operator==(song2)));
	cout << " 3 " << flush;
