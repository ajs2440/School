Script started on Fri 03 May 2019 03:57:44 PM EDT
ajs244@gold33:~/cs214/labs/11/java$ cat ThreadedArraySum.java
/* ThreadedArraySum.java sums the integers in a file using an array and multithreading.
 *
...
public class ThreadedArraySum {
  ...
  public ThreadedArraySum(String [] args) {
     if (args.length < 1) {
        System.err.println("\n*** Usage: java Sum <fileName> <(opt) number of threads>\n");
        System.exit(1);
     }
...
ajs244@gold33:~/cs214/labs/11/java$ java ThreadedArraySum /home/cs/214/labs/11/numbers/1000000numbers.txt 1

The sum of the 1000000 numbers is: 50473230
 and summing them took 3851523 time units.

ajs244@gold33:~/cs214/labs/11/java$ java ThreadedArraySum /home/cs/214/labs/11/numbers/1000000numbers.txt 1 4

The sum of the 1000000 numbers is: 50473230
 and summing them took 7498877 time units.

ajs244@gold33:~/cs214/labs/11/java$ exit

Script done on Fri 03 May 2019 03:58:40 PM EDT
